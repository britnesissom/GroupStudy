...
package ee461l.groupstudyendpoints.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<ee461l.groupstudyendpoints.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, ee461l.groupstudyendpoints.myApi.model.MyBean.class);
