...
public class UserEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public LoadUser loadUser() throws java.io.IOException {
    LoadUser result = new LoadUser();
    initialize(result);
    return result;
  }

  public class LoadUser extends UserEndpointRequest<ee461l.groupstudyendpoints.userEndpoint.model.CollectionResponseUser> {
    ...
    public LoadUser setCount(java.lang.Integer count) {
      this.count = count;
      return this;
    }
    ...
    public LoadUser setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
