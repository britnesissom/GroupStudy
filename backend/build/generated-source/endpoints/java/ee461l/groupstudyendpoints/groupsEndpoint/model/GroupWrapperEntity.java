...
public final class GroupWrapperEntity extends com.google.api.client.json.GenericJson {
   ...
   */
  public GroupWrapperEntity setAdminUser(java.lang.String adminUser) {
   ...
   */
  public GroupWrapperEntity setFileUris(java.util.List<java.lang.String> fileUris) {
   ...
   */
  public GroupWrapperEntity setGroupName(java.lang.String groupName) {
   ...
   */
  public GroupWrapperEntity setId(java.lang.Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GroupWrapperEntity setMessages(java.util.List<java.lang.String> messages) {
   ...
   */
  public GroupWrapperEntity setTasks(java.util.List<java.lang.String> tasks) {
    this.tasks = tasks;
    return this;
  }
   ...
   */
  public GroupWrapperEntity setUsers(java.util.List<java.lang.String> users) {
    this.users = users;
    return this;
  }
