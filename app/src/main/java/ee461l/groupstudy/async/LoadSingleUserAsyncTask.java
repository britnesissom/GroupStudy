 ...
 */
public class LoadSingleUserAsyncTask extends AsyncTask<String, Void, User> {
    ...
    public LoadSingleUserAsyncTask(Context context, OnRetrieveSingleUserTaskCompleted listener,
                            String activityName) {
