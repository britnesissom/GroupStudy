 ...
 */
public class CreateGroupEndpointsAsyncTask extends AsyncTask<Void, Void, Groups> {
    ...
    public CreateGroupEndpointsAsyncTask(Context context, String groupName, String adminUser,
