...
import ee461l.groupstudy.OnRetrieveUsersTaskCompleted;
 ...
 */
public class LoadUsersEndpointsAsyncTask extends AsyncTask<Void, Void, List<User>> {
    private static GroupstudyEndpoint usersEndpointApi = null;
    private Context context;
    private OnRetrieveUsersTaskCompleted listener;

    public LoadUsersEndpointsAsyncTask(Context context, OnRetrieveUsersTaskCompleted listener) {
